...
class LayerGCN(GeneralRecommender):
    ...
    def pre_epoch_processing(self):
        ...
        if self.pruning_random:
            ...
            # 按概率修剪边
            keep_idx = torch.multinomial(self.edge_values, keep_len).to(self.device)  # 将 keep_idx 移动到 self.device

        # 确保 edge_indices 在正确的设备上
        ...
        # 更新 keep_indices 到 users/items + self.n_users
